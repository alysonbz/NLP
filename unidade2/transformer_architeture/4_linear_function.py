...
def split_heads(X, num_heads):
    ...
    return X_heads  # Retorne a matriz transposta dividida corretamente.
...
K_proj = np.dot(Q, W_K) + b_K  # (batch_size, seq_len, d_model)
V_proj = np.dot(Q, W_V) + b_V  # (batch_size, seq_len, d_model)
