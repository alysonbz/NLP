...
def quanti_sentencas(texto1):
    ...
    return len(resp)
texto1 = "olá, meu nome é Emily. Gosto muito do meu cachorro chamdo Pingo."
...
def quanti_maiusculas(texto2):
    ...
    return len(resp)
texto2 = "Hoje a Julia ira para Paris na França"
...
def quanti_caracteres(texto3):
    ...
    return len(resp)
texto3 = "Comprei 2 maças, 3 bananas e 5 uvas"
...
def quanti_caixalta(texto4):
    ...
    return len(resp)
texto4 = "CUIDADO! è perigoso. PERIGO!"
