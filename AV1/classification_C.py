...
from vectorizer import tfidf_vectorizer
#
...
# Pré-processamento com stemming e lematização
X_train_stemmed = [preprocess_text(text, lemmatization=False) for text in X_train]
X_test_stemmed = [preprocess_text(text, lemmatization=False) for text in X_test]

X_train_lemmatized = [preprocess_text(text, lemmatization=True) for text in X_train]
X_test_lemmatized = [preprocess_text(text, lemmatization=True) for text in X_test]
...
# Treinamento e Avaliação com TF-IDF e Stemming
...
# Treinamento e Avaliação com TF-IDF e Lematização
