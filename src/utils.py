...
def load_volunteer_dataset():
    return pd.read_csv('../unidade1/dataset/opportunities.csv')

def load_wine_dataset():
    wine = pd.read_csv('../unidade1/dataset/wine.csv')
    return wine

def load_hiking_dataset():
    return pd.read_json('unidade1/dataset/hiking.json')

def load_df1_unidade1():
    return pd.read_csv('unidade1/dataset/df1_unidade1.csv')


def load_df2_unidade1():
    return pd.read_csv('unidade1/dataset/df2_unidade1.csv')

def load_df1_unidade2():
    return pd.read_csv('unidade1/dataset/df1_unidade2.csv')

def load_df2_unidade2():
    return pd.read_csv('unidade1/dataset/df2_unidade2.csv')

def load_churn_dataset():
    df = pd.read_csv('unidade1/dataset/churn_train.csv')
    le = LabelEncoder()
    df['churn'] = le.fit_transform(df['churn'])
    return df

def load_iris_dataset():
    df = pd.read_csv('unidade1/dataset/iris.csv')
    return df
...
def load_sales_clean_dataset():
    df = pd.read_csv('unidade1/dataset/sales_clean.csv')
    return df

def load_diabetes_clean_dataset():
    df = pd.read_csv('unidade1/dataset/diabetes_clean.csv')
    return df
...
def load_grains_dataset():
    return pd.read_csv('unidade1/dataset/grains.csv')

def load_fish_dataset():
    return pd.read_csv('unidade1/dataset/fish.csv')

def load_movements_price_dataset():
    return pd.read_csv('unidade1/dataset/company-stock-movements-2010-2015-incl.csv')

def load_grains_splited_datadet():
    df = pd.read_csv('unidade1/dataset/grains.csv')
...
def load_movie_review_dataset():
    return pd.read_csv('unidade1/dataset/movie_overviews.csv')
